...
def upgrade():
    ...
    op.add_column('Artist', sa.Column(
        'past_shows', sa.ARRAY(sa.String()), nullable=False))
    op.add_column('Artist', sa.Column(
        'past_shows_count', sa.Integer(), nullable=False))
    op.add_column('Artist', sa.Column('seeking_description',
                                      sa.String(length=500), nullable=False))
    op.add_column('Artist', sa.Column(
        'seeking_venue', sa.Boolean(), nullable=False))
    op.add_column('Artist', sa.Column('upcoming_shows',
                                      sa.ARRAY(sa.String()), nullable=False))
    op.add_column('Artist', sa.Column(
        'upcoming_shows_count', sa.Integer(), nullable=False))
    op.add_column('Artist', sa.Column(
        'website', sa.String(length=500), nullable=False))
    ...
    op.add_column('Venue', sa.Column('upcoming_shows',
                                     sa.ARRAY(sa.String()), nullable=False))
    op.add_column('Venue', sa.Column(
        'upcoming_shows_count', sa.Integer(), nullable=False))
    op.add_column('Venue', sa.Column(
        'website', sa.String(length=120), nullable=False))
